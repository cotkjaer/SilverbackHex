...
{
    @IBInspectable
    public var hexOrientation : HexOrientation = .Vertical { didSet { if hexOrientation != oldValue { prepareHex() } } }
        
    @IBInspectable
    public var hexBorderColor: UIColor = UIColor.clearColor() { didSet { if hexBorderColor != oldValue { prepareHex() } } }
    
    @IBInspectable
    public var hexBorderWidth: CGFloat = CGFloat(0) { didSet { if hexBorderWidth != oldValue { prepareHex() } } }
    ...
    private func prepareHex()
    {
        ...
        let borderWidth = hexBorderWidth// / hexSideLength
