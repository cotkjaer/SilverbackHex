    ...
    override public func layoutAttributesForItemAtIndexPath(indexPath: NSIndexPath) -> UICollectionViewLayoutAttributes?
    {
        ...
        if scrollDirection == .Vertical
        {
            ...
            attributes.center = CGPoint(
                x: ( (CGFloat(col) * itemSize.width) + (0.5 * itemSize.width) + horiOffset),
                y: ( ( (CGFloat(row) * 0.75) * itemSize.height) + (0.5 * itemSize.height) + vertOffset) )
        ...
        else
        {
            ...
            attributes.center = CGPoint(
                x: ( ( (CGFloat(row) * 0.75) * itemSize.width) + (0.5 * itemSize.width) + horiOffset),
                y: ( (CGFloat(col) * itemSize.height) + (0.5 * itemSize.height) + vertOffset) )
        }
